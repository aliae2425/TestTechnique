 ...
 */
final class Version20260219213457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invitation ADD created_at DATETIME NOT NULL, ADD company_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invitation DROP created_at, DROP company_id');
    }
}
